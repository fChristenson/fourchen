...
public class ThreadServletTest {

	private  String URL = "http://localhost:8080/fourChen/Thread.servlet?threadId=";
	...
	public void setUp() throws Exception {
		...
		list.add(new BasicNameValuePair(Keys.THREAD_ID.toString(), threadIdString));
	...
	public void testGet_valid() {
		try {
			get = new HttpGet(URL + thread.getID());
